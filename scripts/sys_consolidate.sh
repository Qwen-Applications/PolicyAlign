...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --save_freq)
            ...
            shift 2
            ;;
        --teacher_mode) TEACHER_MODE="$2" ; shift 2 ;;
        --teacher_ema_decay) TEACHER_EMA_DECAY="$2" ; shift 2 ;;
        *)
            break
            ;;
    esac
...
if [ "${OMPI_COMM_WORLD_RANK:-0}" -eq 0 ]; then
    python3 -m verl.trainer.main_ppo \
        ...
        trainer.teacher_mode=${TEACHER_MODE} \
        trainer.teacher_ema_decay=${TEACHER_EMA_DECAY} \
